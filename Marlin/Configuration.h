...
#define STRING_CONFIG_H_AUTHOR "(Brett Kaufman, Railcore Single)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Single ZL"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3.5, 45, -2.25 } //BAK guess -10,-10, 0, but using railcore
