 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 30                // Seconds BAK
 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD 90                // Seconds BAK
 ...
 */
#define E0_AUTO_FAN_PIN P2_04 //BAK
...
//#define CODEPENDENT_XY_HOMING
  ...
  #define BLTOUCH_DELAY 1200 //bak 500
...
#define STATUS_MESSAGE_SCROLLING //BAK
...
#define BABYSTEPPING //BAK
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // BAK Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 1250   // Maximum interval between clicks, in milliseconds.
                                            // Note: Extra time may be added to mitigate controller latency.
    #define BABYSTEP_ALWAYS_AVAILABLE     // BAK Allow babystepping at all times (not just during movement).
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // BAK Combine M851 Z and Babystepping
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       740        // (mA) RMS current. Multiply by 1.414 for peak current. BAK 780
