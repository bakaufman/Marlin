...
#define BABYSTEPPING //BAK
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  10       // BAK Babysteps are very small. Increase for faster motion.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. BAK
